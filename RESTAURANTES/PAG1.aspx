    ...
    <section id="content" class="auto-style8"><div class="ic"></div> 
        <div>
            ...
            <div>
                ...
                <ajaxToolkit:ConfirmButtonExtender ID="Button2_ConfirmButtonExtender" runat="server" ConfirmText="¿Esta seguro de generar su voto?" OnClientCancel="Operación cancelada" TargetControlID="Button2" />
            </div>
        </div>       
        </section>
