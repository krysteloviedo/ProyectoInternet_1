                ...
                <td class="aligncenter">&nbsp;<table class="auto-style3">
                   ...
                   <br/>
                    ...
                    <asp:Button ID="BtnGuardar" runat="server" Text="Guardar" />
                                            <ajaxToolkit:ConfirmButtonExtender ID="BtnGuardar_ConfirmButtonExtender" runat="server" ConfirmText="¿Esta seguro de guardar sus datos ?" OnClientCancel="CancelClick" TargetControlID="BtnGuardar" />
                                        </td>
                                        <td>
                    <asp:Button ID="BtnLimpiar" runat="server" Text="Limpiar" />
                                            <ajaxToolkit:ConfirmButtonExtender ID="BtnLimpiar_ConfirmButtonExtender" runat="server" ConfirmText="Los  datos ingresados seran eliminados" OnClientCancel="Operación cancelada" TargetControlID="BtnLimpiar" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
