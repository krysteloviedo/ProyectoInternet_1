Partial Class MenuAdministrador_ReportesVtasCategoria
    ...
    Protected Sub butCon_Click(sender As Object, e As System.EventArgs) Handles butCon.Click
        Try
            ...
            strSQL = "Select sum(ODE.total) as SumaCategoria, CAT.nombre as Nombre"
            ...
            End If
            strSQL = strSQL & " group by CAT.nombre"
