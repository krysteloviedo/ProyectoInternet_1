...
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="TxtClave" ErrorMessage="Datos incorrectos">*</asp:RequiredFieldValidator>
                    ...
                    <tr>
                        ...
                        <td class="auto-style11">
                            ...
                            <ajaxToolkit:ConfirmButtonExtender ID="BtnLimpiar_ConfirmButtonExtender" runat="server" TargetControlID="BtnLimpiar" ConfirmText="Sus Datos seran eliminados" OnClientCancel="Operación cancelada" />
                        </td>
                    </tr>
                    </table>   
            </div>
