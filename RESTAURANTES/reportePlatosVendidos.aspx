<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="reportePlatosVendidos.aspx.vb" Inherits="reportePlatosVendidos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row">
        <div class="col-sm-6">
            <div>
                <asp:Label ID="Label1" runat="server" Text="Tipo reporte"></asp:Label>
                <asp:DropDownList ID="cboTipo" runat="server">
                <asp:ListItem Enabled="true" Text="Seleccione tipo de reporte" Value="-1"></asp:ListItem>
                <asp:ListItem Text="Más vendidos" Value="1"></asp:ListItem>
                <asp:ListItem Text="Menos vendidos" Value="2"></asp:ListItem>       
            </asp:DropDownList>
            </div>
            <div>
        ...
        <div class="col-sm-6">     
            <asp:GridView ID="gridPlatos" runat="server" AutoGenerateColumns="False"   
